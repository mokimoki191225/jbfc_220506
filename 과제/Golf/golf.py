...
def 선수점수정렬():       #높은 순서대로 정렬
    ...
    players_stroke = 선수점수가져오기(filename,excel_file)
...
def 양파최고기록(infos,excel_file): #양파 추가!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    wb, ws, ws2 = loading_excel(excel_file)
...
def 최고기록선수넣기():
    infos = 선수정보담기()
    버디최고기록(infos,excel_file)
    파최고기록(infos,excel_file)
    보기최고기록(infos,excel_file)
    양파최고기록(infos,excel_file)  # 양파 추가!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
